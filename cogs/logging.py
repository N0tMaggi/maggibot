...
class Logging(commands.Cog):
    ...
    async def on_application_command(self, ctx):
        ...
        # Überprüfen, ob der Benutzer ein Member ist (damit top_role und activity verfügbar sind)
        if isinstance(ctx.author, discord.Member):
            ...
            # Activity-Informationen nur für Mitglieder verfügbar
            ...
            # `joined_at` nur für Member verfügbar
        ...
        # Überprüfen, ob der Kanal ein DM-Kanal ist
